...
export function LobbyScreen({ onMatchFound }) {
	...
	const userName = session?.user?.name || session?.userId || "Player";
			...
			<div className="lobby-screen__header">
				<div className="lobby-profile">
					...
					<div className="lobby-profile__info">
						<span className="lobby-profile__name">
							{userName}
						</span>
						<span className="lobby-profile__status">
							Online
						</span>
					</div>
				</div>
			...
			<div className="lobby-screen__content">
				...
				<div className="lobby-stats">
					<div className="lobby-stat">
						<span className="lobby-stat__val">
							1,204
						</span>
						<span className="lobby-stat__lbl">
							Score
						</span>
					</div>
					<div className="lobby-stat">
